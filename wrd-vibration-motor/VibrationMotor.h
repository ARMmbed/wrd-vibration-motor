...
#define DEFAULT_PIN YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_VIBRATION_MOTOR_ENABLE_PWM_PIN
#else
#define DEFAULT_PIN NC
#endif

#ifdef YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_VIBRATION_MOTOR_ENABLE_PWM_PULSE_WIDTH_UNIT_US
#define PULSE_WIDTH_UNIT YOTTA_CFG_HARDWARE_WEARABLE_REFERENCE_DESIGN_VIBRATION_MOTOR_ENABLE_PWM_PULSE_WIDTH_UNIT_US
#else
#define PULSE_WIDTH_UNIT 10000
#endif
