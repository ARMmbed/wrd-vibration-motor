...
#define DEFAULT_PIN YOTTA_CFG_HARDWARE_WRD_VIBRATION_MOTOR_ENABLE_PWM_PIN
#else
#define DEFAULT_PIN NC
#endif

#ifdef YOTTA_CFG_HARDWARE_WRD_VIBRATION_MOTOR_ENABLE_PWM_PULSE_WIDTH_UNIT_US
#define PULSE_WIDTH_UNIT YOTTA_CFG_HARDWARE_WRD_VIBRATION_MOTOR_ENABLE_PWM_PULSE_WIDTH_UNIT_US
#else
